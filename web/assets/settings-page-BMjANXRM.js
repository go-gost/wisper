          ...
          <div class="card">
            <div class="card-padded">
              ...
              <div class="form-group" style="display:flex;align-items:center;gap:10px;">
                ...
                ${this._p2pTest?d`<span class="${this._p2pTest.ok?"test-ok":"p2p-warning"}">
                      ${this._p2pTest.ok?`${e("p2pTestOk")} · ${this._p2pTest.latency} ms`:`${e("p2pTestFailed")}: ${this._p2pTest.error??""}`}
                    </span>`:""}
              </div>
