import{i as u,a as v,j as c,b as a,t as b,h as q,w as L,c as I,g as U}from"./index--zb5Z7nE.js";import{n as d,r as h}from"./state-D3BSW4Rm.js";import{i as D}from"./app-scaffold-BE4q86e5.js";import{c as R,f as E}from"./format-CZNH9DXL.js";class W{constructor(t){this.baseUrl=t.replace(/\/$/,"")}async liveness(){try{return(await fetch(`${this.baseUrl}/liveness`)).ok}catch{return!1}}async query(t){const r=new URLSearchParams;r.set("client_id",t.client_id),t.type&&r.set("type",t.type),t.service&&r.set("service",t.service),t.sid&&r.set("sid",t.sid),t.start!==void 0&&r.set("start",String(t.start)),t.end!==void 0&&r.set("end",String(t.end)),t.before&&r.set("before",t.before),t.after&&r.set("after",t.after),t.limit!==void 0&&r.set("limit",String(t.limit));const o=await fetch(`${this.baseUrl}/api/records/query?${r.toString()}`);if(!o.ok)throw new Error(`Inspector query failed: ${o.status}`);return o.json()}connectTail(t){const r=new URLSearchParams;r.set("client_id",t.client_id),t.type&&r.set("type",t.type),t.service&&r.set("service",t.service),t.sid&&r.set("sid",t.sid);const o=this.baseUrl.replace(/^http/,"ws");return new WebSocket(`${o}/api/records/tail?${r.toString()}`)}}function H(e){const t=atob(e),r=new Uint8Array(t.length);for(let o=0;o<t.length;o++)r[o]=t.charCodeAt(o);return r}var N=Object.defineProperty,F=Object.getOwnPropertyDescriptor,M=(e,t,r,o)=>{for(var s=o>1?void 0:o?F(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(o?n(t,r,s):n(s))||s);return o&&s&&N(t,r,s),s};const K=[{type:"http",labelKey:"inspectorProtocolHttp"},{type:"websocket",labelKey:"inspectorProtocolWs"}];let $=class extends v{constructor(){super(...arguments),this.active="http"}render(){return a`
      <div class="tabs">
        ${K.map(e=>a`
  ...
  `;M([d()],$.prototype,"active",2);$=M([b("protocol-tabs")],$);var A=Object.defineProperty,J=Object.getOwnPropertyDescriptor,j=(e,t,r,o)=>{for(var s=o>1?void 0:o?J(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(o?n(t,r,s):n(s))||s);return o&&s&&A(t,r,s),s};let w=class extends v{constructor(){super(...arguments),this.mode="query"}render(){return a`
      <div class="toggle">
    ...
    `}_setMode(e){this.mode=e,this.dispatchEvent(new CustomEvent("mode-change",{detail:e,bubbles:!0,composed:!0}))}};w.styles=u`
    :host { display: block; }
    .toggle {
  ...
  `;z([d()],C.prototype,"sid",2);C=z([b("inspector-filter-bar")],C);var V=Object.defineProperty,X=Object.getOwnPropertyDescriptor,O=(e,t,r,o)=>{for(var s=o>1?void 0:o?X(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(o?n(t,r,s):n(s))||s);return o&&s&&V(t,r,s),s};const x=4096;let g=class extends v{constructor(){super(...arguments),this.body="",this._tab="text"}_decode(){if(!this.body)return new Uint8Array(0);try{return H(this.body)}catch{return new TextEncoder().encode(this.body)}}_renderContent(){const e=this._decode();switch(this._tab){case"hex":return this._renderHexdump(e);case"json":try{const t=new TextDecoder().decode(e);return JSON.stringify(JSON.parse(t),null,2)}catch{return new TextDecoder().decode(e)}default:return new TextDecoder().decode(e)}}_renderHexdump(e){const t=e.length>x?e.slice(0,x):e,r=[];for(let o=0;o<t.length;o+=16){let s="",i="";for(let n=0;n<16;n++){n===8&&(s+=" ");const k=o+n;if(k>=t.length)s+="   ";else{const y=t[k];s+=y.toString(16).padStart(2,"0")+" ",i+=y>=32&&y<=126?String.fromCharCode(y):"."}}r.push(`${o.toString(16).padStart(8,"0")}  ${s} |${i}|`)}return e.length>x&&r.push(`... (${(e.length-x).toLocaleString()} more bytes not shown)`),r.join(`
`)}_copyContent(){navigator.clipboard.writeText(this._renderContent())}render(){return a`
  ...
  `;O([d()],g.prototype,"body",2);O([h()],g.prototype,"_tab",2);g=O([b("body-viewer")],g);var Y=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,B=(e,t,r,o)=>{for(var s=o>1?void 0:o?Z(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(o?n(t,r,s):n(s))||s);return o&&s&&Y(t,r,s),s};let P=class extends v{constructor(){super(...arguments),this.record=null}render(){const e=this.record;return e?a`
      <div class="panel">
        <div class="section">
        ...
        ${e.http?a`
          ...
          <div class="section">
            ...
            <pre>${R(e.http.request.header)}</pre>
          </div>
          <div class="section">
            <div class="section-title">${c("inspectorDetailHeaders")} — Response</div>
            <pre>${R(e.http.response.header)}</pre>
          </div>
  ...
  `;B([d({attribute:!1})],P.prototype,"record",2);P=B([b("record-detail")],P);var ee=Object.getOwnPropertyDescriptor,te=(e,t,r,o)=>{for(var s=o>1?void 0:o?ee(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=n(s)||s);return s};let T=class extends v{render(){return a`<div class="spinner"></div>`}};T.styles=u`
    :host {
  ...
  `;T=te([b("wisper-spinner")],T);var se=Object.defineProperty,re=Object.getOwnPropertyDescriptor,_=(e,t,r,o)=>{for(var s=o>1?void 0:o?re(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(o?n(t,r,s):n(s))||s);return o&&s&&se(t,r,s),s};function oe(e){const t=e.toUpperCase();return t==="GET"?"method-green":t==="POST"||t==="PUT"||t==="PATCH"?"method-blue":t==="CONNECT"?"method-yellow":t==="DELETE"?"method-red":"method-default"}function ie(e){return e>=200&&e<300?"var(--green)":e>=400?"var(--red)":"var(--text-muted)"}let f=class extends v{constructor(){super(...arguments),this.records=[],this.protocol="http",this.selectedIndex=-1,this.hasMore=!1,this.loading=!1,this._observer=null}updated(){this._observer&&this._observer.disconnect(),this._observer=new IntersectionObserver(t=>{t[0]?.isIntersecting&&this.hasMore&&this.dispatchEvent(new CustomEvent("load-more",{bubbles:!0,composed:!0}))});const e=this.shadowRoot?.querySelector(".sentinel");e&&this._observer.observe(e)}disconnectedCallback(){super.disconnectedCallback(),this._observer?.disconnect()}_renderRow(e,t){const r=e.http?.host||e.host,o=e.http?.method||"",s=e.http?.uri||"",i=e.http?.statusCode||0,n=e.websocket?.opcode;return a`
      <div class="row ${this.selectedIndex===t?"selected":""}"
        ...
        `:""}
        <div class="right">
          <div>↓${E(e.inputBytes)}</div>
          <div>↑${E(e.outputBytes)}</div>
        </div>
      </div>
  ...
  `;_([d({attribute:!1})],f.prototype,"records",2);_([d()],f.prototype,"protocol",2);_([d({type:Number})],f.prototype,"selectedIndex",2);_([d({type:Boolean})],f.prototype,"hasMore",2);_([d({type:Boolean})],f.prototype,"loading",2);f=_([b("record-list")],f);var ne=Object.defineProperty,ae=Object.getOwnPropertyDescriptor,S=(e,t,r,o)=>{for(var s=o>1?void 0:o?ae(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(o?n(t,r,s):n(s))||s);return o&&s&&ne(t,r,s),s};let m=class extends v{constructor(){super(...arguments),this.connected=!1,this.recordCount=0,this.stopped=!1}render(){return a`
      <div class="bar">
        <span class="status">
  ...
  `;S([d({type:Boolean})],m.prototype,"connected",2);S([d({type:Number})],m.prototype,"recordCount",2);S([d({type:Boolean})],m.prototype,"stopped",2);m=S([b("live-indicator")],m);var ce=Object.defineProperty,le=Object.getOwnPropertyDescriptor,p=(e,t,r,o)=>{for(var s=o>1?void 0:o?le(t,r):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(s=(o?n(t,r,s):n(s))||s);return o&&s&&ce(t,r,s),s};let l=class extends v{constructor(){super(...arguments),this.parentKind="tunnel",this.parentType="",this.parentId="",this._mode="query",this._protocol="http",this._records=[],this._selectedIndex=-1,this._sid="",this._cursor=null,this._hasMore=!0,this._loading=!1,this._liveConnected=!1,this._liveStopped=!1,this._error="",this._client=null,this._clientUrl="",this._unsub=null,this._ws=null,this._reconnectDelay=1e3,this._reconnectTimer=null}connectedCallback(){super.connectedCallback(),this._initClient(),this._fetchRecords(),this._unsub=q(()=>this._onSettings())}disconnectedCallback(){super.disconnectedCallback(),this._closeWs(),this._reconnectTimer&&clearTimeout(this._reconnectTimer),this._unsub?.(),this._unsub=null}_initClient(){const e=L().inspector_url||"";return e&&e!==this._clientUrl?(this._client=new W(e),this._clientUrl=e,!0):!1}_onSettings(){const e=!this._client;this._initClient()&&e&&(this._mode==="query"?(this._hasMore=!0,this._cursor=null,this._fetchRecords()):this._openWs())}_getClientId(){return this.parentKind==="tunnel"?this.parentId:I().find(r=>r.id===this.parentId)?.options?.tunnel_id||this.parentId}_getParentName(){return this.parentKind==="tunnel"?U().find(r=>r.id===this.parentId)?.name||this.parentId:I().find(t=>t.id===this.parentId)?.name||this.parentId}async _fetchRecords(e){if(!(!this._client||this._loading)){this._loading=!0,this._error="";try{const t=await this._client.query({client_id:this._getClientId(),type:this._protocol,sid:this._sid||void 0,before:e,limit:100});if(t.code===0&&t.data){const r=t.data.list||[];e?this._records=[...this._records,...r]:this._records=r,this._cursor=t.data.before||null,this._hasMore=r.length>=100}else this._error=t.msg||t.error||`query failed (code ${t.code})`}catch(t){this._error=t instanceof Error?t.message:String(t),console.error("[inspector] query failed:",t)}this._loading=!1}}_onLoadMore(){this._mode==="query"&&this._hasMore&&this._cursor&&this._fetchRecords(this._cursor)}_openWs(){if(this._client){this._closeWs(),this._liveStopped=!1,this._reconnectDelay=1e3;try{this._ws=this._client.connectTail({client_id:this._getClientId(),type:this._protocol,sid:this._sid||void 0}),this._ws.onopen=()=>{this._liveConnected=!0},this._ws.onmessage=e=>{try{const t=JSON.parse(e.data);this._records=[t,...this._records].slice(0,200)}catch{}},this._ws.onclose=()=>{this._liveConnected=!1,this._liveStopped||this._scheduleReconnect()},this._ws.onerror=()=>{this._ws?.close()}}catch{}}}_scheduleReconnect(){this._reconnectTimer&&clearTimeout(this._reconnectTimer),this._reconnectTimer=setTimeout(()=>{this._openWs(),this._reconnectDelay=Math.min(this._reconnectDelay*2,3e4)},this._reconnectDelay)}_closeWs(){this._ws&&(this._ws.onclose=null,this._ws.onmessage=null,this._ws.close(),this._ws=null),this._liveConnected=!1}_onModeChange(e){const t=e.detail;this._mode=t,this._selectedIndex=-1,t==="live"?(this._records=[],this._openWs()):(this._closeWs(),this._records=[],this._fetchRecords())}_onProtocolChange(e){this._protocol=e.detail,this._selectedIndex=-1,this._mode==="live"?(this._records=[],this._openWs()):(this._records=[],this._hasMore=!0,this._cursor=null,this._fetchRecords())}_onFilterChange(e){const{sid:t}=e.detail;this._sid=t,this._selectedIndex=-1,this._mode==="live"?(this._records=[],this._openWs()):(this._records=[],this._hasMore=!0,this._cursor=null,this._fetchRecords())}_onRecordSelect(e){const t=e.detail;this._selectedIndex=this._selectedIndex===t?-1:t}_onLiveStop(){this._liveStopped=!0,this._closeWs(),this._reconnectTimer&&clearTimeout(this._reconnectTimer)}_onLiveReconnect(){this._liveStopped=!1,this._openWs()}_onLiveClear(){this._records=[],this._selectedIndex=-1}_navigate(e){window.history.pushState({},"",e),window.dispatchEvent(new PopStateEvent("popstate"))}render(){const e=this._getParentName(),t=this.parentKind==="tunnel"?`/tunnel/${this.parentType}/${this.parentId}`:`/entrypoint/${this.parentType}/${this.parentId}`,r=this._getClientId().slice(0,8);return this._client?a`
      <app-scaffold>
    ...
    .spacer { height: 8px; }
  `;p([d()],l.prototype,"parentKind",2);p([d()],l.prototype,"parentType",2);p([d()],l.prototype,"parentId",2);p([h()],l.prototype,"_mode",2);p([h()],l.prototype,"_protocol",2);p([h()],l.prototype,"_records",2);p([h()],l.prototype,"_selectedIndex",2);p([h()],l.prototype,"_sid",2);p([h()],l.prototype,"_cursor",2);p([h()],l.prototype,"_hasMore",2);p([h()],l.prototype,"_loading",2);p([h()],l.prototype,"_liveConnected",2);p([h()],l.prototype,"_liveStopped",2);p([h()],l.prototype,"_error",2);l=p([b("inspector-page")],l);export{l as InspectorPage};
