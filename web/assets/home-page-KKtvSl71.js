const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Hz3f-8Us.js","assets/index-DIq3FqVg.css"])))=>i.map(i=>d[i]);
import{i as g,a as x,b as i,t as y,g as _,c as $,d as w,e as k,s as F,f as P,h as I,j as e,k as S,l as z,m as L,n as j,_ as E,o as R,p as D}from"./index-Hz3f-8Us.js";import{n as l,r as v}from"./state-DQeFf1Ap.js";import{i as h}from"./app-scaffold-O_dUiI2j.js";import{f as C,a as T,b as B,c as N}from"./format-B-__ZPmv.js";var O=Object.defineProperty,q=Object.getOwnPropertyDescriptor,m=(t,n,r,a)=>{for(var s=a>1?void 0:a?q(n,r):n,c=t.length-1,o;c>=0;c--)(o=t[c])&&(s=(a?o(n,r,s):o(s))||s);return a&&s&&O(n,r,s),s};let f=class extends x{constructor(){super(...arguments),this.tabs=[],this.activeIndex=0}_handleClick(t){t!==this.activeIndex&&(this.activeIndex=t,this.dispatchEvent(new CustomEvent("tab-change",{detail:{index:t},bubbles:!0,composed:!0})))}render(){return i`
  ...
  `;m([l({type:Array})],f.prototype,"tabs",2);m([l({type:Number})],f.prototype,"activeIndex",2);f=m([y("nav-tabs")],f);var A=Object.defineProperty,H=Object.getOwnPropertyDescriptor,p=(t,n,r,a)=>{for(var s=a>1?void 0:a?H(n,r):n,c=t.length-1,o;c>=0;c--)(o=t[c])&&(s=(a?o(n,r,s):o(s))||s);return a&&s&&A(n,r,s),s};let d=class extends x{constructor(){super(...arguments),this.name="",this.meta="",this.status="stopped",this.endpoint="",this.currentConns=0,this.totalConns=0,this.requestRate=0,this.inputBytes=0,this.outputBytes=0,this.inputRate=0,this.outputRate=0,this.expanded=!1,this.compact=!0,this.error=""}_onRowClick(t){this.dispatchEvent(new CustomEvent("card-click",{bubbles:!0,composed:!0}))}_onChevronClick(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("chevron-click",{bubbles:!0,composed:!0}))}render(){const t=this.status==="stopped";return i`
                            ...
                            <div class="detail-card">
                              <div class="detail-row">
                                ...
                                <span class="dval">${a.data.entrypoint}
                                  <button class="copy-btn-mini" @click=${async o=>{o.stopPropagation(),await N(a.data.entrypoint),this._showSnackbar(e("copiedToClipboard"))}}>
                                    ${h("copy")}
                                  </button>
                                </span>
                              </div>
