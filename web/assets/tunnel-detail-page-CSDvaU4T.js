...
`).map(o=>o.trim()).filter(Boolean)),this._showAuth&&(s.username=this._username.trim()||void 0,s.password=this._password||void 0),this.mode==="create"?(await f(()=>import("./index-DW5_i-0E.js").then(o=>o.E),__vite__mapDeps([0,1])).then(o=>o.create(s)),this._showSnackbar(e("saved")),this._navigate("/")):(await f(()=>import("./index-DW5_i-0E.js").then(o=>o.E),__vite__mapDeps([0,1])).then(o=>o.update(this.tunnelId,s)),this._showSnackbar(e("saved")),this.mode="view",await $())}catch(s){const o=s instanceof Error?s.message:"";this._showSnackbar(`${e("saveFailed")}${o?": "+o:""}`)}this._saving=!1}async _handleDelete(){this._showDeleteDialog=!1;try{await k(this.tunnelId),this._showSnackbar(e("deleted")),this._navigate("/")}catch{this._showSnackbar(e("deleteFailed"))}}async _handleStart(){try{await T(this.tunnelId),this._showSnackbar(e("started"))}catch{this._showSnackbar(e("startFailed"))}}async _handleStop(){try{await S(this.tunnelId),this._showSnackbar(e("stopped"))}catch{this._showSnackbar(e("stopFailed"))}}async _handleCopy(t){await F(t),this._showSnackbar(e("copiedToClipboard"))}_handleResetStats(t){this._resetKind=t,this._showResetDialog=!0}async _doResetStats(){this._showResetDialog=!1;try{await D(this.tunnelId,this._resetKind),this._tunnel&&R(this.tunnelId,this._tunnel.stats),this._showSnackbar(e("saved"))}catch{this._showSnackbar(e("saveFailed"))}}_typeLabel(){return e(`type${this.tunnelType.charAt(0).toUpperCase()+this.tunnelType.slice(1)}`)}_cycleOption(t,s){const o=s.indexOf(t);return s[(o+1)%s.length]}_setRecordMode(t){this._recordMode=t,this.requestUpdate()}render(){const t=this._tunnel,s=t?t.stats:null,o=this._typeLabel();return a`
        ...
        ${this.mode==="view"&&t?a`
            ...
            <div class="section">
              <div class="card">
                ...
                ${this.tunnelType==="p2p"?a`<div class="p2p-hint">${e("p2pHint")}</div>`:z}
                ${t.options.prefix?a`
                    <div class="info-row">
            ...
            ${this.mode==="view"&&t&&(this.tunnelType==="http"||this.tunnelType==="file")&&P().inspector_url?a`
                <div class="section">
  ...
  `;r([_()],n.prototype,"tunnelType",2);r([_()],n.prototype,"tunnelId",2);r([l()],n.prototype,"mode",2);r([l()],n.prototype,"_tunnel",2);r([l()],n.prototype,"_saving",2);r([l()],n.prototype,"_snackbar",2);r([l()],n.prototype,"_showDeleteDialog",2);r([l()],n.prototype,"_showResetDialog",2);r([l()],n.prototype,"_name",2);r([l()],n.prototype,"_endpoint",2);r([l()],n.prototype,"_hostname",2);r([l()],n.prototype,"_prefix",2);r([l()],n.prototype,"_username",2);r([l()],n.prototype,"_password",2);r([l()],n.prototype,"_enableTLS",2);r([l()],n.prototype,"_rewriteHost",2);r([l()],n.prototype,"_fileUpload",2);r([l()],n.prototype,"_showAuth",2);r([l()],n.prototype,"_showPassword",2);r([l()],n.prototype,"_recordMode",2);r([l()],n.prototype,"_peers",2);n=r([C("tunnel-detail-page")],n);export{n as TunnelDetailPage};
