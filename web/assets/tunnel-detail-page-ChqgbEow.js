        ...
        ${this.mode==="view"&&t?i`
            ...
            <div class="section">
              <div class="card">
                ...
                ${this.tunnelType==="p2p"?i`<div class="p2p-hint">${e("p2pHint")}</div>`:z}
                ${t.options.prefix?i`
                    <div class="info-row">
            ...
            ${this.mode==="view"&&t&&(this.tunnelType==="http"||this.tunnelType==="file")&&P().inspector_url?i`
                <div class="section">
