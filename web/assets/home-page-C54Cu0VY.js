const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Dgeo2YKt.js","assets/index-DIq3FqVg.css"])))=>i.map(i=>d[i]);
import{i as g,a as x,b as i,t as y,g as _,c as $,d as w,e as k,s as F,f as P,h as I,j as e,k as S,l as z,m as L,n as j,_ as E,o as R,p as D}from"./index-Dgeo2YKt.js";import{n as p,r as v}from"./state-CoEzwZPc.js";import{i as h}from"./app-scaffold-BbDEDkeD.js";import{c as B}from"./clipboard-C3x8_sid.js";import{f as C,a as T,b as N}from"./format-CZNH9DXL.js";var O=Object.defineProperty,q=Object.getOwnPropertyDescriptor,m=(t,n,r,a)=>{for(var s=a>1?void 0:a?q(n,r):n,c=t.length-1,o;c>=0;c--)(o=t[c])&&(s=(a?o(n,r,s):o(s))||s);return a&&s&&O(n,r,s),s};let f=class extends x{constructor(){super(...arguments),this.tabs=[],this.activeIndex=0}_handleClick(t){t!==this.activeIndex&&(this.activeIndex=t,this.dispatchEvent(new CustomEvent("tab-change",{detail:{index:t},bubbles:!0,composed:!0})))}render(){return i`
