...
import{a as m,f as _,c as y,j as e,_ as b,v as x,w,l as $,n as k,x as S,u as D,b as s,i as z,t as T}from"./index-B0R-xDvz.js";import{d as C,m as E,c as v,a as u,b as f,n as g,r as l}from"./format-OjawwSAq.js";import{i as d}from"./app-scaffold-D0h6qpeX.js";import{c as I}from"./clipboard-C3x8_sid.js";var R=Object.defineProperty,P=Object.getOwnPropertyDescriptor,n=(t,a,r,p)=>{for(var i=p>1?void 0:p?P(a,r):a,c=t.length-1,h;c>=0;c--)(h=t[c])&&(i=(p?h(a,r,i):h(i))||i);return p&&i&&R(a,r,i),i};let o=class extends m{constructor(){super(...arguments),this.entrypointType="tcp",this.entrypointId="",this.mode="view",this._entrypoint=null,this._saving=!1,this._snackbar="",this._showDeleteDialog=!1,this._showResetDialog=!1,this._resetKind="",this._name="",this._endpoint="",this._tunnelId="",this._peer="",this._showPeer=!1,this._protocol="tcp",this._keepalive=!0,this._unsubs=[]}connectedCallback(){super.connectedCallback(),this._load(),this._unsubs.push(_(()=>{this._load(),this.requestUpdate()}))}disconnectedCallback(){super.disconnectedCallback();for(const t of this._unsubs)t();this._unsubs=[]}_load(){const t=this.entrypointId,a=window.location.search.includes("edit");if(t==="new"||!t){if(this.mode==="create")return;this.mode="create",this._entrypoint=null,this._resetForm();return}if(this.mode==="edit"&&this._entrypoint?.id===t)return;const r=y().find(p=>p.id===t);r&&(this._entrypoint=r,a?(this.mode="edit",this._populateForm(r)):(this.mode!=="edit"||this._entrypoint?.id!==t)&&(this.mode="view",this._populateForm(r)))}_resetForm(){this._name="",this._endpoint="",this._tunnelId="",this._peer="",this._protocol="tcp",this._keepalive=!0}_populateForm(t){this._name=t.name,this._endpoint=t.entrypoint,this._tunnelId=t.id??"",this._peer=t.options?.peer??"",this._protocol=t.options?.protocol==="udp"?"udp":"tcp",this._keepalive=t.options?.keepalive??!0}_navigate(t){window.history.pushState({},"",t),window.dispatchEvent(new PopStateEvent("popstate"))}_enterEdit(){this._entrypoint&&(this._populateForm(this._entrypoint),this.mode="edit")}_showSnackbar(t){this._snackbar=t,setTimeout(()=>{this._snackbar="",this.requestUpdate()},2500)}async _handleSave(){if(!this._name.trim()){this._showSnackbar(e("requiredField"));return}this._saving=!0;try{const t={name:this._name.trim(),type:this.entrypointType,endpoint:this._endpoint.trim(),id:this._tunnelId.trim()||void 0,peer:this._peer.trim()||void 0,protocol:this.entrypointType==="p2p"?this._protocol:void 0,keepalive:this.entrypointType==="p2p"&&this._protocol==="udp"?this._keepalive:void 0};this.mode==="create"?(await b(()=>import("./index-B0R-xDvz.js").then(a=>a.H),__vite__mapDeps([0,1])).then(a=>a.create(t)),this._showSnackbar(e("saved")),this._navigate("/")):(await b(()=>import("./index-B0R-xDvz.js").then(a=>a.H),__vite__mapDeps([0,1])).then(a=>a.update(this.entrypointId,t)),this._showSnackbar(e("saved")),this.mode="view",await x())}catch(t){const a=t instanceof Error?t.message:"";this._showSnackbar(`${e("saveFailed")}${a?": "+a:""}`)}this._saving=!1}async _handleDelete(){this._showDeleteDialog=!1;try{await w(this.entrypointId),this._showSnackbar(e("deleted")),this._navigate("/")}catch{this._showSnackbar(e("deleteFailed"))}}async _handleStart(){try{await $(this.entrypointId),this._showSnackbar(e("started"))}catch{this._showSnackbar(e("startFailed"))}}async _handleStop(){try{await k(this.entrypointId),this._showSnackbar(e("stopped"))}catch{this._showSnackbar(e("stopFailed"))}}async _handleCopy(t){await I(t),this._showSnackbar(e("copiedToClipboard"))}_handleResetStats(t){this._resetKind=t,this._showResetDialog=!0}async _doResetStats(){this._showResetDialog=!1;try{await S(this.entrypointId,this._resetKind),this._entrypoint&&D(this.entrypointId,this._entrypoint.stats),this._showSnackbar(e("saved"))}catch{this._showSnackbar(e("saveFailed"))}}_typeLabel(){return this.entrypointType.toUpperCase()}render(){const t=this._entrypoint,a=t?t.stats:null,r=this._typeLabel(),p=t?.options?.peer??"";return s`
              ...
              <div class="card">
                ...
                ${this.entrypointType==="p2p"?s`
                    <div class="info-row">
                      ...
                      <span class="info-value">${this._showPeer?p:E(p)}</span>
                      ${p?s`<button class="copy-btn-mini" @click=${()=>this._handleCopy(p)}>
                          ${d("copy")}
                        </button>
  ...
  `;n([g()],o.prototype,"entrypointType",2);n([g()],o.prototype,"entrypointId",2);n([l()],o.prototype,"mode",2);n([l()],o.prototype,"_entrypoint",2);n([l()],o.prototype,"_saving",2);n([l()],o.prototype,"_snackbar",2);n([l()],o.prototype,"_showDeleteDialog",2);n([l()],o.prototype,"_showResetDialog",2);n([l()],o.prototype,"_name",2);n([l()],o.prototype,"_endpoint",2);n([l()],o.prototype,"_tunnelId",2);n([l()],o.prototype,"_peer",2);n([l()],o.prototype,"_showPeer",2);n([l()],o.prototype,"_protocol",2);n([l()],o.prototype,"_keepalive",2);o=n([T("entrypoint-detail-page")],o);export{o as EntrypointDetailPage};
