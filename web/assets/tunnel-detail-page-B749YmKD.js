...
`).map(o=>o.trim()).filter(Boolean)),this._showAuth&&(a.username=this._username.trim()||void 0,a.password=this._password||void 0),this.mode==="create"?(await f(()=>import("./index-D5ZCHVAE.js").then(o=>o.E),__vite__mapDeps([0,1])).then(o=>o.create(a)),this._showSnackbar(e("saved")),this._navigate("/")):(await f(()=>import("./index-D5ZCHVAE.js").then(o=>o.E),__vite__mapDeps([0,1])).then(o=>o.update(this.tunnelId,a)),this._showSnackbar(e("saved")),this.mode="view",await T())}catch(a){const o=a instanceof Error?a.message:"";this._showSnackbar(`${e("saveFailed")}${o?": "+o:""}`)}this._saving=!1}async _handleDelete(){this._showDeleteDialog=!1;try{await S(this.tunnelId),this._showSnackbar(e("deleted")),this._navigate("/")}catch{this._showSnackbar(e("deleteFailed"))}}async _handleStart(){try{await D(this.tunnelId),this._showSnackbar(e("started"))}catch{this._showSnackbar(e("startFailed"))}}async _handleStop(){try{await P(this.tunnelId),this._showSnackbar(e("stopped"))}catch{this._showSnackbar(e("stopFailed"))}}async _handleCopy(t){await M(t),this._showSnackbar(e("copiedToClipboard"))}_handleResetStats(t){this._resetKind=t,this._showResetDialog=!0}async _doResetStats(){this._showResetDialog=!1;try{await R(this.tunnelId,this._resetKind),this._tunnel&&z(this.tunnelId,this._tunnel.stats),this._showSnackbar(e("saved"))}catch{this._showSnackbar(e("saveFailed"))}}_typeLabel(){return e(`type${this.tunnelType.charAt(0).toUpperCase()+this.tunnelType.slice(1)}`)}_cycleOption(t,a){const o=a.indexOf(t);return a[(o+1)%a.length]}_setRecordMode(t){this._recordMode=t,this.requestUpdate()}render(){const t=this._tunnel,a=t?t.stats:null,o=this._typeLabel(),p=t?.active_peers??[];return s`
      <app-scaffold>
        ...
        ${this.mode==="view"&&t?s`
            ...
            <div class="section">
              <div class="card">
                ...
                <div class="info-row">
                  ...
                  ${t.entrypoint?s`
                      <span class="info-value">${this._showPeers?t.entrypoint:m(t.entrypoint)}</span>
                ...
                ${this.tunnelType==="p2p"?s`<div class="p2p-hint">${e("p2pHint")}</div>`:b}
                    ...
                    <div class="info-row">
                      ...
                      ${p.length?s`
                          <span class="info-value">
                            ${this._showPeers?p.join(", "):m(p.join(", "))}
                          </span>
                          <button class="copy-btn-mini" title="${this._showPeers?e("hideKey"):e("revealKey")}"
                            @click=${()=>{this._showPeers=!this._showPeers}}>
                            ${d(this._showPeers?"eye-off":"eye")}
            ...
            ${this.mode==="view"&&t&&(this.tunnelType==="http"||this.tunnelType==="file")&&E().inspector_url?s`
                <div class="section">
