...
`).map(o=>o.trim()).filter(Boolean).map(o=>{const[p,...i]=o.split(/\s+/),c=i.join(" ");return c?{key:p,alias:c}:{key:p}})),this._showAuth&&(s.username=this._username.trim()||void 0,s.password=this._password||void 0),this.mode==="create"?(await b(()=>import("./index-BTehLM11.js").then(o=>o.E),__vite__mapDeps([0,1])).then(o=>o.create(s)),this._showSnackbar(e("saved")),this._navigate("/")):(await b(()=>import("./index-BTehLM11.js").then(o=>o.E),__vite__mapDeps([0,1])).then(o=>o.update(this.tunnelId,s)),this._showSnackbar(e("saved")),this.mode="view",await T())}catch(s){const o=s instanceof Error?s.message:"";this._showSnackbar(`${e("saveFailed")}${o?": "+o:""}`)}this._saving=!1}async _handleDelete(){this._showDeleteDialog=!1;try{await S(this.tunnelId),this._showSnackbar(e("deleted")),this._navigate("/")}catch{this._showSnackbar(e("deleteFailed"))}}async _handleStart(){try{await D(this.tunnelId),this._showSnackbar(e("started"))}catch{this._showSnackbar(e("startFailed"))}}async _handleStop(){try{await P(this.tunnelId),this._showSnackbar(e("stopped"))}catch{this._showSnackbar(e("stopFailed"))}}async _handleCopy(t){await M(t),this._showSnackbar(e("copiedToClipboard"))}_handleResetStats(t){this._resetKind=t,this._showResetDialog=!0}async _doResetStats(){this._showResetDialog=!1;try{await R(this.tunnelId,this._resetKind),this._tunnel&&z(this.tunnelId,this._tunnel.stats),this._showSnackbar(e("saved"))}catch{this._showSnackbar(e("saveFailed"))}}_typeLabel(){return e(`type${this.tunnelType.charAt(0).toUpperCase()+this.tunnelType.slice(1)}`)}_cycleOption(t,s){const o=s.indexOf(t);return s[(o+1)%s.length]}_setRecordMode(t){this._recordMode=t,this.requestUpdate()}render(){const t=this._tunnel,s=t?t.stats:null,o=this._typeLabel(),p=t?.active_peers??[];return a`
      <app-scaffold>
        ...
        <div slot="appBar" style="display:flex;align-items:center;gap:8px;">
          ...
          ${this.mode==="view"&&t?a`
              ${t.status==="running"?a`<button class="pill-btn danger appbar-action" title="${e("btnStop")}" @click=${()=>this._handleStop()}>
                  ${d("stop")}
                </button>`:a`<button class="pill-btn primary appbar-action" title="${e("btnStart")}" @click=${()=>this._handleStart()}>
                  ${d("play")}
                </button>`}
            `:a`
        ...
        ${this.mode==="view"&&t?a`
            ...
            <div class="section">
              <div class="card">
                ...
                ${this.tunnelType==="p2p"?a`
                    <div class="info-row">
                      ...
                      ${t.entrypoint?a`
                        ...
                        `:a`<span class="info-value empty">${e("p2pPeersEmpty")}</span>`}
                    </div>
                  `:t.entrypoint?a`
                      <div class="info-row">
                    ...
                    `:f}
                ${this.tunnelType==="p2p"?a`<div class="p2p-hint">${e("p2pHint")}</div>`:f}
                <!-- Live state, refreshed by the stats poll: which allowlisted
                     peers actually hold a stream right now. -->
                ${this.tunnelType==="p2p"?a`
                    <div class="info-row">
                      <span class="info-label">${e("p2pConnected")}</span>
                      ${p.length?a`
                          <span class="info-value">
                            ${p.map(i=>this._peerLabelOf(i)).join(", ")}
                          </span>
                          <button class="copy-btn-mini" title="${this._showPeers?e("hideKey"):e("revealKey")}"
                            @click=${()=>{this._showPeers=!this._showPeers}}>
                            ${d(this._showPeers?"eye-off":"eye")}
                          </button>
                        `:a`<span class="info-value empty">${e("p2pConnectedEmpty")}</span>`}
                    </div>
                  `:f}
                ${t.options.prefix?a`
                    <div class="info-row">
                ...
                <div class="info-row">
                  ...
                  <span class="info-value text">${e(h.find(i=>i.value===this._recordMode)?.labelKey??"settingsRecordFull")}</span>
                </div>
              ...
              ${s?a`
                  <div class="stats-grid">
                    ...
                    <div class="stat-box">
                      ...
                      <div class="stat-rate">${_(s.output_rate_bytes)}</div>
                    </div>
                    <div class="stat-box">
                      ...
                      <div class="stat-rate">${_(s.input_rate_bytes)}</div>
                    </div>
                  </div>
                `:""}
            </div>
            ...
            ${this.mode==="view"&&t&&(this.tunnelType==="http"||this.tunnelType==="file")&&E().inspector_url?a`
                <div class="section">
        ...
        ${this.mode!=="view"?a`
            <div class="section">
              <div class="card" style="padding:16px;">
                ...
                ${this.tunnelType==="p2p"?a`
                    <div class="form-group">
                      ...
                      <textarea class="form-input" rows="3" placeholder="<public key> [alias]"
                        .value=${this._peers}
                        @input=${i=>{this._peers=i.target.value}}></textarea>
                ...
                ${this.tunnelType==="p2p"?"":a`
                <div class="switch-row" @click=${()=>this._setRecordMode(this._cycleOption(this._recordMode,h.map(i=>i.value)))}>
                  ...
                  <span style="font-size:var(--font-sm);color:var(--text-muted);display:flex;align-items:center;gap:4px;">
                    ${e(h.find(i=>i.value===this._recordMode)?.labelKey??"settingsRecordFull")}
                    ${d("chevron-right")}
                  </span>
                </div>
  ...
  `;r([y()],n.prototype,"tunnelType",2);r([y()],n.prototype,"tunnelId",2);r([l()],n.prototype,"mode",2);r([l()],n.prototype,"_tunnel",2);r([l()],n.prototype,"_saving",2);r([l()],n.prototype,"_snackbar",2);r([l()],n.prototype,"_showDeleteDialog",2);r([l()],n.prototype,"_showResetDialog",2);r([l()],n.prototype,"_name",2);r([l()],n.prototype,"_endpoint",2);r([l()],n.prototype,"_hostname",2);r([l()],n.prototype,"_prefix",2);r([l()],n.prototype,"_username",2);r([l()],n.prototype,"_password",2);r([l()],n.prototype,"_enableTLS",2);r([l()],n.prototype,"_rewriteHost",2);r([l()],n.prototype,"_fileUpload",2);r([l()],n.prototype,"_showAuth",2);r([l()],n.prototype,"_showPassword",2);r([l()],n.prototype,"_recordMode",2);r([l()],n.prototype,"_showPeers",2);r([l()],n.prototype,"_peers",2);n=r([L("tunnel-detail-page")],n);export{n as TunnelDetailPage};
