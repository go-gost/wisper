        ...
        <div class="section">
          ...
          <div class="card">
            <div class="card-padded">
              ...
              ${this._p2pTest&&!this._p2pTest.ok?d`<p class="hint">${this._p2pTest.error??""}</p>`:""}
