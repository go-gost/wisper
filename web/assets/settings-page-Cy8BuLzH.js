import{a as f,G as y,o as b,h as m,y as x,j as e,z as l,b as d,i as w,t as k}from"./index-BTd_AQzi.js";import{m as $,r as n}from"./format-dLnkyJ6y.js";import{i as r}from"./app-scaffold-BJd_Akv4.js";import{c as P}from"./clipboard-C3x8_sid.js";var T=Object.defineProperty,S=Object.getOwnPropertyDescriptor,a=(t,s,p,c)=>{for(var o=c>1?void 0:c?S(s,p):s,h=t.length-1,v;h>=0;h--)(v=t[h])&&(o=(c?v(s,p,o):v(o))||o);return c&&o&&T(s,p,o),o};const u=[{value:"system",labelKey:"settingsThemeSystem"},{value:"light",labelKey:"settingsThemeLight"},{value:"dark",labelKey:"settingsThemeDark"}],g=[{value:"en",labelKey:"settingsLangEn"},{value:"zh",labelKey:"settingsLangZh"}],_=[{value:1,labelKey:"settingsInterval1s"},{value:2,labelKey:"settingsInterval2s"},{value:3,labelKey:"settingsInterval3s"},{value:5,labelKey:"settingsInterval5s"},{value:10,labelKey:"settingsInterval10s"},{value:30,labelKey:"settingsInterval30s"}];let i=class extends f{constructor(){super(...arguments),this._server="",this._entrypoint="",this._insecure=!1,this._p2pDerp="",this._p2pSecure=!0,this._p2pCaFile="",this._showP2PKey=!1,this._p2pTesting=!1,this._p2pTest=null,this._p2pPublicKey="",this._p2pRunning=!1,this._theme="system",this._lang="en",this._statsInterval=3,this._inspectorUrl="",this._inspectorConnected=!1,this._inspectorTested=!1,this._snackbar="",this._saving=!1,this._version="",this._unsubs=[],this._backend=new y,this._livenessTimer=null}connectedCallback(){super.connectedCallback();const t=b();this._server=t.server,this._entrypoint=t.entrypoint,this._insecure=t.insecure,this._p2pDerp=t.p2p?.derp||"",this._p2pSecure=t.p2p?.secure??!0,this._p2pCaFile=t.p2p?.ca_file||"",this._theme=t.theme,this._lang=t.lang,this._statsInterval=t.stats_interval||1,this._inspectorUrl=t.inspector_url||"",this._unsubs.push(m(()=>{const s=b();this._server=s.server,this._entrypoint=s.entrypoint,this._insecure=s.insecure,this._p2pDerp=s.p2p?.derp||"",this._p2pSecure=s.p2p?.secure??!0,this._p2pCaFile=s.p2p?.ca_file||"",this._theme=s.theme,this._lang=s.lang,this._statsInterval=s.stats_interval||1,this._inspectorUrl=s.inspector_url||"",this.requestUpdate(),this._fetchP2PIdentity()}),x(()=>this.requestUpdate())),this._fetchVersion(),this._fetchP2PIdentity()}async _fetchVersion(){try{const t=await this._backend.getVersion();this._version=t.version}catch{this._version=""}}async _fetchP2PIdentity(){try{const t=await this._backend.getP2PIdentity();this._p2pPublicKey=t.public_key,this._p2pRunning=t.running}catch{this._p2pPublicKey="",this._p2pRunning=!1}}async _testP2P(){this._p2pTesting=!0,this._p2pTest=null;try{const t=await this._backend.testP2PRelay({derp:this._p2pDerp,secure:this._p2pSecure,ca_file:this._p2pCaFile});this._p2pTest={ok:t.ok,latency:t.latency_ms,error:t.error}}catch(t){this._p2pTest={ok:!1,error:String(t)}}this._p2pTesting=!1}async _copyP2PKey(){await P(this._p2pPublicKey),this._showSnackbar(e("copiedToClipboard"))}disconnectedCallback(){super.disconnectedCallback();for(const t of this._unsubs)t();this._livenessTimer&&clearTimeout(this._livenessTimer)}_navigate(t){window.history.pushState({},"",t),window.dispatchEvent(new PopStateEvent("popstate"))}_showSnackbar(t){this._snackbar=t,setTimeout(()=>{this._snackbar="",this.requestUpdate()},2e3)}async _saveSettings(){this._saving=!0;try{await l({server:this._server,entrypoint:this._entrypoint,insecure:this._insecure,p2p:{derp:this._p2pDerp,secure:this._p2pSecure,ca_file:this._p2pCaFile}}),this._showSnackbar("✓ "+e("saved"))}catch{this._showSnackbar(e("saveFailed"))}this._saving=!1}async _setTheme(t){this._theme=t,this.requestUpdate(),this._showSnackbar("✓ "+e(u.find(s=>s.value===t)?.labelKey??"settingsThemeSystem"));try{await l({theme:t})}catch{}}async _setLang(t){this._lang=t,this.requestUpdate(),this._showSnackbar("✓ "+e(g.find(s=>s.value===t)?.labelKey??"settingsLangEn"));try{await l({lang:t})}catch{}}async _setInterval(t){this._statsInterval=t,this.requestUpdate(),this._showSnackbar("✓ "+e(_.find(s=>s.value===t)?.labelKey??"settingsInterval1s"));try{await l({stats_interval:t})}catch{}}_onInspectorUrlChange(t){this._inspectorUrl=t,this._livenessTimer&&clearTimeout(this._livenessTimer),this._livenessTimer=setTimeout(()=>this._checkLiveness(),500)}async _checkLiveness(){if(!this._inspectorUrl){this._inspectorConnected=!1,this._inspectorTested=!1;return}try{const t=await fetch(`${this._inspectorUrl.replace(/\/$/,"")}/liveness`);this._inspectorConnected=t.ok,this._inspectorTested=!0}catch{this._inspectorConnected=!1,this._inspectorTested=!0}this.requestUpdate()}async _saveInspectorUrl(){try{await l({inspector_url:this._inspectorUrl}),this._showSnackbar("✓ "+e("saved"))}catch{this._showSnackbar(e("saveFailed"))}}_cycleOption(t,s){const p=s.indexOf(t);return s[(p+1)%s.length]}render(){return d`
      <app-scaffold>
            ...
            <div class="card-padded">
              <div class="form-group">
                ...
                <div style="display:flex;align-items:center;gap:8px;">
                  <span class="identity-key">${this._showP2PKey?this._p2pPublicKey:$(this._p2pPublicKey)}</span>
                ...
                ${this._p2pRunning?"":d`<p class="hint">${e("p2pIdentityIdle")}</p>`}
              </div>
              <div class="form-group">
              ...
              ${this._p2pTest&&!this._p2pTest.ok?d`<p class="p2p-warning">${this._p2pTest.error??""}</p>`:""}
        ...
        <div class="section">
          ...
          <div class="card">
            ...
            <div class="selector-row" @click=${()=>this._setInterval(this._cycleOption(this._statsInterval,_.map(t=>t.value)))}>
              <span class="selector-label">${e("settingsStatsInterval")}</span>
              <span class="selector-value">
                ${e(_.find(t=>t.value===this._statsInterval)?.labelKey??"settingsInterval1s")}
                ${r("chevron-right")}
              </span>
            </div>
          </div>
        ...
        ${this._snackbar?d`<div class="toast">${this._snackbar}</div>`:""}
      </app-scaffold>
    `}};i.styles=w`
    /* ── Back nav ── */
    .back-btn {
  ...
  `;a([n()],i.prototype,"_server",2);a([n()],i.prototype,"_entrypoint",2);a([n()],i.prototype,"_insecure",2);a([n()],i.prototype,"_p2pDerp",2);a([n()],i.prototype,"_p2pSecure",2);a([n()],i.prototype,"_p2pCaFile",2);a([n()],i.prototype,"_showP2PKey",2);a([n()],i.prototype,"_p2pTesting",2);a([n()],i.prototype,"_p2pTest",2);a([n()],i.prototype,"_p2pPublicKey",2);a([n()],i.prototype,"_p2pRunning",2);a([n()],i.prototype,"_theme",2);a([n()],i.prototype,"_lang",2);a([n()],i.prototype,"_statsInterval",2);a([n()],i.prototype,"_inspectorUrl",2);a([n()],i.prototype,"_inspectorConnected",2);a([n()],i.prototype,"_inspectorTested",2);a([n()],i.prototype,"_snackbar",2);a([n()],i.prototype,"_saving",2);a([n()],i.prototype,"_version",2);i=a([k("settings-page")],i);export{i as SettingsPage};
