            ...
            <div class="card-padded">
              <div style="display:flex;align-items:center;gap:8px;">
                <span class="identity-key ${this._p2pRunning?"":"muted"}">
                  ${this._p2pRunning?this._p2pPublicKey:e("p2pIdentityIdle")}
                </span>
                ${this._p2pRunning?h`<button class="copy-btn-mini" title="${e("btnCopy")}" @click=${()=>this._copyP2PKey()}>
                    ${o("copy")}
                  </button>`:""}
              </div>
