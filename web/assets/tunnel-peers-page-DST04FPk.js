import{a as y,j as s,s as x,g as h,B as m,b as i,A as c,i as w,t as $}from"./index-CFNpXpUT.js";import{c as k,a as f,b as v,m as E,n as _,r as p}from"./format-CeFrG29E.js";import{i as d}from"./app-scaffold-C3PoCN6S.js";import{c as z}from"./clipboard-C3x8_sid.js";import{a as D}from"./transport-DiTZ6gM2.js";var K=Object.defineProperty,C=Object.getOwnPropertyDescriptor,o=(e,t,r,a)=>{for(var l=a>1?void 0:a?C(t,r):t,u=e.length-1,b;u>=0;u--)(b=e[u])&&(l=(a?b(t,r,l):b(l))||l);return a&&l&&K(t,r,l),l};function P(e){if(!/^[A-Za-z0-9_-]{43}$/.test(e))return!1;try{const t=e+"=".repeat((4-e.length%4)%4);return atob(t.replace(/-/g,"+").replace(/_/g,"/")).length===32}catch{return!1}}function g(e){return(e?.options.peers??[]).map(t=>({key:t.key,alias:t.alias??"",disabled:t.disabled===!0}))}let n=class extends y{constructor(){super(...arguments),this.tunnelType="",this.tunnelId="",this._tunnel=null,this._rows=[],this._editing=null,this._draft={key:"",alias:"",disabled:!1},this._saving=!1,this._rowError="",this._confirmDelete=null,this._showKeys=!1,this._snackbar="",this._unsub=null,this._toggleRow=async e=>{const t=this._rows.map((r,a)=>a===e?{...r,disabled:!r.disabled}:r);await this._save(t)},this._saveRow=async()=>{const e={key:this._draft.key.trim(),alias:this._draft.alias.trim(),disabled:this._draft.disabled===!0};if(!P(e.key)){this._rowError=s("peersKeyInvalid");return}if(this._rows.filter((a,l)=>l!==this._editing).some(a=>a.key===e.key)){this._rowError=s("peersKeyDuplicate");return}const r=this._editing==="new"?[...this._rows,e]:this._rows.map((a,l)=>l===this._editing?e:a);await this._save(r)&&(this._editing=null,this._rowError="")},this._deleteRow=async e=>{this._confirmDelete=null,await this._save(this._rows.filter((t,r)=>r!==e))}}connectedCallback(){super.connectedCallback(),this._load(),this._unsub=x(()=>{const e=h().find(t=>t.id===this.tunnelId);e&&(this._tunnel=e)})}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.()}_load(){const e=h().find(t=>t.id===this.tunnelId)??null;this._tunnel=e,this._rows=g(e)}_startEdit(e){this._editing=e,this._draft={...this._rows[e]},this._rowError=""}_startAdd(){this._editing="new",this._draft={key:"",alias:"",disabled:!1},this._rowError=""}_cancelEdit(){this._editing=null,this._rowError=""}async _save(e){if(this._saving)return!1;this._saving=!0;try{const t=await m(this.tunnelId,e.map(r=>({key:r.key,alias:r.alias||void 0,disabled:r.disabled||void 0})));return this._tunnel=t,this._rows=g(t),this._showSnackbar(s("saved")),!0}catch(t){const r=t instanceof Error?t.message:"",a=`${s("saveFailed")}${r?": "+r:""}`;return this._editing!==null?this._rowError=a:this._showSnackbar(a),!1}finally{this._saving=!1}}_showSnackbar(e){this._snackbar=e,setTimeout(()=>{this._snackbar=""},2500)}_navigate(e){window.history.pushState({},"",e),window.dispatchEvent(new PopStateEvent("popstate"))}_statFor(e){return(this._tunnel?.peer_stats??[]).find(t=>t.key===e)}_renderStats(e){const t=this._statFor(e);return t?i`
      <span>${k(t.current_conns)} ${s("p2pColConns")}</span>
      <span>↓ ${f(t.output_bytes)} <span class="rate">${v(t.output_rate_bytes)}</span></span>
      <span>↑ ${f(t.input_bytes)} <span class="rate">${v(t.input_rate_bytes)}</span></span>
  ...
  `;o([_()],n.prototype,"tunnelType",2);o([_()],n.prototype,"tunnelId",2);o([p()],n.prototype,"_tunnel",2);o([p()],n.prototype,"_rows",2);o([p()],n.prototype,"_editing",2);o([p()],n.prototype,"_draft",2);o([p()],n.prototype,"_saving",2);o([p()],n.prototype,"_rowError",2);o([p()],n.prototype,"_confirmDelete",2);o([p()],n.prototype,"_showKeys",2);o([p()],n.prototype,"_snackbar",2);n=o([$("tunnel-peers-page")],n);export{n as TunnelPeersPage};
