...
// NewUDPTunnel creates a UDP port-forwarding tunnel.
...
func (s *udpTunnel) ID() string       { return s.opts.ID }
func (s *udpTunnel) Type() string     { return UDPTunnel }
...
func (s *udpTunnel) IsFavorite() bool { return s.favorite.Load() }

func (s *udpTunnel) init() error {
	rudpSvc := &config.ServiceConfig{
		Name: s.opts.Name,
