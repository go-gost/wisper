...
// NewTCPTunnel creates a TCP port-forwarding tunnel.
...
func (s *tcpTunnel) ID() string       { return s.opts.ID }
func (s *tcpTunnel) Type() string     { return TCPTunnel }
...
func (s *tcpTunnel) IsFavorite() bool { return s.favorite.Load() }
