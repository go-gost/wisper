...
const ICON_PATHS: Record<string, SVGInner> = {
  ...
  qr: svg`<rect x="3" y="3" width="7" height="7" rx="1" /><rect x="14" y="3" width="7" height="7" rx="1" /><rect x="3" y="14" width="7" height="7" rx="1" /><path d="M14 14h3v3h-3z" /><path d="M19 19h2v2h-2z" /><path d="M14 19h2v2h-2z" />`,

  /* ── Form ── */
  eye: svg`<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" /><circle cx="12" cy="12" r="3" />`,
  'eye-off': svg`<path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24" /><line x1="1" y1="1" x2="23" y2="23" />`,
  ...
  // p2p transport states: a bolt for a direct path, its crossed form for a
  // failed punch, a crossed cloud for a STUN server that does not answer.
  zap: svg`<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />`,
  'zap-off': svg`<polyline points="12.41 6.75 13 2 10.57 4.92" /><polyline points="18.57 12.91 21 10 15.66 10" /><polyline points="8 8 3 14 12 14 11 22 16 16" /><line x1="1" y1="1" x2="23" y2="23" />`,
